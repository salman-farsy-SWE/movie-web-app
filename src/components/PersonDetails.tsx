...
export function PersonDetails({
    ...
    return (
        <div className="relative mt-[19px] left-1/2 right-1/2 w-screen -translate-x-1/2 bg-light-dropdown xl:px-5 lg:px-6 md:px-7 sm:px-8 px-9 xl:py-[29px] lg:py-[27px] md:py-[20px] sm:py-[15px] py-[21px] flex justify-center">
            <div className="container-1440 flex sm:flex-row flex-col">
                ...
                <div className="h-fit xl:ml-[28px] lg:ml-[26px] md:ml-[24px] sm:ml-[20px] xl:mt-[26px] lg:mt-[22px] md:mt-[18px] sm:mt-[14px] mt-[16px] flex flex-col xl:gap-[25px] lg:gap-[23px] md:gap-[19px] sm:gap-[15px] gap-[13px] xl:text-[20px] lg:text-[18px] md:text-[16px] sm:text-[14px] text-[12px] font-medium font-inter text-black">
