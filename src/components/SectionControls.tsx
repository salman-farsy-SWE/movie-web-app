  ...
  return (
    <>
      <Button
        ...
        aria-label="Previous"
        className={cn(
          "absolute xl:left-[-20px] lg:left-[-23px] md:left-[-22px] sm:left-[-21px] left-[-20px] xl:top-[59px] lg:top-[51px] md:top-[53px] sm:top-[51px] top-[40px] z-10 xl:h-[63px] xl:w-[63px] lg:h-[61px] lg:w-[61px] md:h-[58px] md:w-[58px] sm:h-[55px] sm:w-[55px] h-[46px] w-[46px] rounded-full",
      ...
      <Button
        ...
        aria-label="Next"
        className={cn(
          "absolute xl:right-[-20px] lg:right-[-23px] md:right-[-22px] sm:right-[-21px] right-[-20px] xl:top-[59px] lg:top-[51px] md:top-[53px] sm:top-[51px] top-[40px] z-10 xl:h-[63px] xl:w-[63px] lg:h-[61px] lg:w-[61px] md:h-[58px] md:w-[58px] sm:h-[55px] sm:w-[55px] h-[46px] w-[46px] rounded-full",
          "bg-light-carousal-btn/20 dark:bg-carousal-btn/20 backdrop-blur-[30px]",
          "flex items-center justify-center transition",
          "hover:bg-light-carousal-btn/20 dark:hover:bg-carousal-btn/20",
          canScrollRight
