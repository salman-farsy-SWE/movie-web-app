    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="flex flex-col items-center drop-shadow-[0_2px_6px_rgba(0,0,0,0.25)]">
                <span className="md:block hidden xl:w-[37px] xl:h-[20px] lg:w-[31px] lg:h-[16px] md:w-[27px] md:h-[14px] bg-light-dropdown dark:bg-dropdown [clip-path:polygon(50%_0%,0%_100%,100%_100%)]"></span>
