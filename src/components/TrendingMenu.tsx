    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="flex flex-col items-center drop-shadow-[0_2px_6px_rgba(0,0,0,0.25)]">
                <span className="md:block hidden xl:w-[37px] xl:h-[18px] lg:w-[31px] lg:h-[14px] md:w-[27px] md:h-[12px] bg-light-dropdown dark:bg-dropdown [clip-path:polygon(50%_0%,0%_100%,100%_100%)]"></span>

                <div className="flex justify-center md:bg-light-dropdown bg-white dark:bg-dropdown xl:w-[217px] xl:h-[271px] lg:w-[200px] lg:h-[250px] w-[160px] h-[220px] -translate-y-[2px] md:rounded-none rounded-[4px]">
