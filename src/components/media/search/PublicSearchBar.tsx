...
import type { MovieItem, Person, SearchBarBaseProps } from "@/types";

export type PublicSearchType = "media" | "person";

export interface PublicSearchBarProps extends SearchBarBaseProps {
  enableSuggestions?: boolean;
  searchType?: PublicSearchType;
}

export function PublicSearchBar(props: PublicSearchBarProps) {
  return (
    <Suspense
      fallback={
        <div
    ...
    >
      <PublicSearchBarContent {...props} />
    </Suspense>
  );
}

function PublicSearchBarContent({
