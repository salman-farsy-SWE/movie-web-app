...
export function CollectionPagination(props: PaginationProps) {
  return (
    <Suspense fallback={null}>
      <CollectionPaginationContent {...props} />
    </Suspense>
  );
}

function CollectionPaginationContent({
  ...
  const handlePageClick = (pageNumber: number, e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    const targetUrl = createPageURL(pageNumber);
  ...
  return (
    <nav
      aria-label="Collection Pagination Navigation"
      className={cn(
